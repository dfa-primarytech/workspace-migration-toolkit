...
- Checks: 38 Python tests passed; Ruff, formatting, mypy, Bandit, pip-audit, secret scan and JavaScript syntax passed. Existing DOCX tests passed 10/10 on merged main. GitHub CI passed its Linux container build/smoke test. Offline preflight passed against a two-slide file generated by installed Microsoft PowerPoint (720 x 540 pt; 2 text boxes, 1 shape, 1 table); this private validation artifact was kept outside Git.
